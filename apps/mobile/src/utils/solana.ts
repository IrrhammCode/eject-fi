...
const DISCRIMINATORS = {
  initialize_vault: new Uint8Array([140, 91, 51, 170, 230, 233, 102, 178]),
  deposit: new Uint8Array([242, 35, 198, 137, 82, 225, 242, 182]),
  emergency_eject: new Uint8Array([210, 115, 233, 12, 118, 55, 192, 123]),
};

// Helper: concatenate Uint8Arrays without Buffer.concat
...
export async function buildInitAndDepositTx(
  ...
  tx.add(
    new TransactionInstruction({
      ...
      data: DISCRIMINATORS.initialize_vault as any,
    })
  );
...
export async function handleEjectTransaction(
  ...
  tx.add(
    new TransactionInstruction({
      ...
      data: DISCRIMINATORS.emergency_eject as any,
    })
  );
